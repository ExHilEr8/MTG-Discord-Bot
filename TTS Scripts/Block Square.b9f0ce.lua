...
local smallSetsNoBasics = {["VIS"]="nil", ["WTH"]="nil", ["STH"]="nil", ["EXO"]="nil", ["ULG"]="nil", ["UDS"]="nil", ["NEM"]="nil", ["PCY"]="nil", ["PLS"]="nil", ["APC"]="nil", ["TOR"]="nil", ["JUD"]="nil", ["LGN"]="nil", ["SCG"]="nil", ["DST"]="nil", ["5DN"]="nil", ["BOK"]="nil", ["SOK"]="nil", ["GPT"]="nil", ["DIS"]="nil", ["CSP"]="nil", ["MOR"]="nil", ["EVE"]="nil", ["CON"]="ALA", ["ARB"]="ALA", ["WWK"]="ZEN", ["GTC"]="RTR", ["BNG"]="THS", ["JOU"]="THS", ["AER"]="KLD"}
...
local funkySets = {
    ...
    ['DGM-2']='10_r:c -t:land|3_r:u|1_1/8_r:r_r:m -t:land|1_noset (s:rtr or s:gtc) is:shockland',
    ...
    ['TSP']='10_r:c|3_r:u|1_r:r|1_noset s:tsb',
...
self.createInput({
    ...
    font_size=78, validation=4, label="Set", value=setCode
})
                        ...
                        function()
                            ...
                            if rng <= tonumber(odds1) then
                                if starts_with(q2, "noset") then
                                    ...
                                    newURL = "https://api.scryfall.com/cards/random?q="..urlencode("(is:booster lang:english game:paper -t:token -t:plane -t:scheme -t:phenomenon -t:dungeon -t:vanguard -!Plains -!Island -!Swamp -!Mountain -!Forest) ")
                                elseif starts_with(q2, "otherbasic") then
                                    newQ2 = newQ2:sub(#"otherbasic"+1, #newQ2).." (!Plains or !Island or !Swamp or !Mountain or !Forest)"
                                    newURL = "https://api.scryfall.com/cards/random?q="..urlencode("(is:booster lang:english game:paper -t:token -t:plane -t:scheme -t:phenomenon -t:dungeon -t:vanguard) ")
                                end
